...
@safetestset "locate_project_file" include("tests_locate_project_file.jl")
VERSION >= v"1.12" && @safetestset "workspace" include("tests_workspace.jl")
@safetestset "stdlib_packages" include("tests_stdlib_packages.jl")
@safetestset "usingany_throws" include("tests_usingany_throws.jl")
@safetestset "usingany_kwargs" include("tests_usingany_kwargs.jl")
