...
@testset "update" begin
    ...
    if VERSION >= v"1.11" # worked on 1.11 but throws on 1.10 and may throw on 1.12
...
@testset "delete_env" begin
    ...
    if VERSION >= v"1.11" # deleting with faked project worked on 1.11 but throws on 1.10 and might 1.12 
